...
## 11) Base officielle du projet (`esportify-2.sql`)
Le projet est maintenant aligne sur le dump:
- `database/esportify-2.sql`

Configuration DB commune:
- `src/main/resources/db.properties`
  - `db.name=esportify`
  - `db.url=jdbc:mysql://localhost:3306/esportify?serverTimezone=UTC`
  - `db.user=root`
  - `db.password=`

Import rapide du dump:
- PowerShell:
