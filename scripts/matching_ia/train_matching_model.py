...
def train_model(csv_path: Path, output_dir: Path) -> None:
    ...
    metadata_path = output_dir / "matching_model_metadata.json"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Entrainement du modele Matching IA Esportify")
    parser.add_argument(
        "--dataset",
        default="scripts/matching_ia/data/matching_training_dataset.csv",
        help="Chemin vers le CSV d'entrainement",
    )
    parser.add_argument(
        "--output-dir",
        default="scripts/matching_ia/output",
