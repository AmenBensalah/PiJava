...
public class CommandeService {
    ...
    private void createTableIfNotExists() {
        if (connection == null) {
            System.err.println("CommandeService: connexion BD indisponible, creation table ignoree.");
            return;
        }
    ...
    public boolean aDejaCommande(String email) {
        ...
        if (connection == null) {
            System.err.println("CommandeService: verification ignoree, connexion BD indisponible.");
            return false;
        }
