...
public final class AppSession {
    ...
    public void logout() {
        ...
        discardLocalCartWithoutDeletingDatabaseRows();
        username = null;
        role = null;
        currentUser = null;
        selectedEquipe = null;
    ...
    private void discardLocalCartWithoutDeletingDatabaseRows() {
        try {
            OrderSession.getInstance().discardLocalCart();
        } catch (Throwable ignored) {
            // Logout must never delete the saved database cart or block navigation.
        }
    }
